    ...
    return (
        <div className="py-8">
            <PageHeader
                ...
                subtitle="Governing rules for the use of the University Campus Portal."
            />
                ...
                <div className="bg-white border border-slate-100 rounded-[32px] p-8 md:p-12 shadow-sm">
                    <section className="mb-10">
                        ...
                        <p className="text-slate-600 leading-relaxed">
                            By accessing and using the University Campus Portal, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service and the University’s Digital Use Policy. If you do not agree to these terms, please do not use the portal.
                        </p>
                    </section>
                    ...
                    <section className="mb-10">
                        ...
                        <ul className="list-disc list-inside text-slate-600 space-y-3">
                            ...
                            <li>The University is not liable for any loss resulting from unauthorized use of your account.</li>
                        </ul>
                    </section>
                    ...
                    <section className="mb-10">
                        ...
                        <p className="text-slate-600 leading-relaxed mb-4">
                            All submissions made via the portal are subject to the University's Academic Integrity Policy.
                        </p>
                        <ul className="list-disc list-inside text-slate-600 space-y-3">
                    ...
                    <section className="mb-10">
                        ...
                        <p className="text-slate-600 leading-relaxed">
                            All content on the portal, including designs, text, and graphics, is the property of the University. Academic materials provided by faculty are for your personal educational use only and may not be redistributed without permission.
                        </p>
                    </section>
                    ...
                    <section className="mb-10">
                        ...
                        <p className="text-slate-600 leading-relaxed">
                            While we strive for 24/7 uptime, portal access may be temporarily suspended for maintenance or updates. The University reserves the right to modify portal features or these terms at any time without prior notice.
                        </p>
                    </section>
                    ...
                    <section className="mb-10">
                        ...
                        <p className="text-slate-600 leading-relaxed">
                            The University shall not be held liable for any direct, indirect, or incidental damages arising out of the use or inability to use the portal, including data loss or system errors.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-slate-600 leading-relaxed">
                            These terms are governed by the laws of the jurisdiction in which the University is located. Any disputes will be subject to the exclusive jurisdiction of its courts.
                        </p>
                    </section>
                </div>
            </div>
